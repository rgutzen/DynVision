...
class ResNet(LightningBase):
    ...
    def _forward(self, x_0: torch.Tensor, t: torch.Tensor = None, **kwargs) -> torch.Tensor:
...
class ResNet20(ResNet):
    def __init__(self, **kwargs):
        super(ResNet20, self).__init__(BasicBlock, num_blocks=[3, 3, 3], **kwargs)
        
class ResNet32(ResNet):
    def __init__(self, **kwargs):
        super(ResNet32, self).__init__(BasicBlock, num_blocks=[5, 5, 5], **kwargs)

class ResNet44(ResNet):
    def __init__(self, **kwargs):
        super(ResNet44, self).__init__(BasicBlock, num_blocks=[7, 7, 7], **kwargs)

class ResNet56(ResNet):
    def __init__(self, **kwargs):
        super(ResNet56, self).__init__(BasicBlock, num_blocks=[9, 9, 9], **kwargs)

class ResNet110(ResNet):
    def __init__(self, **kwargs):
        super(ResNet110, self).__init__(BasicBlock, num_blocks=[18, 18, 18], **kwargs)

class ResNet1202(ResNet):
    def __init__(self, **kwargs):
        super(ResNet1202, self).__init__(BasicBlock, num_blocks=[200, 200, 200], **kwargs)
