...
def _extract_metadata(
    ...
    """Extract and validate metadata from config YAML file.
    ...
    Returns:
        FileMetadata with parameter value, category value, and extra values
    """
    import yaml
    ...
    # Extract category value from model arguments path
